...
public class GoogleSheets {
     ...
     * @return
     */
    public List<List<Object>> getAccountsInfo() throws IOException, GeneralSecurityException {
        // Build a new authorized API client service.
        final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
        final String spreadsheetId = "19a-3oybCT6P0YTUmYTMd610UwHxHQAs43HScUrH4g-w";
        final String range = "OldAccounts!A2:D";
        Sheets service =
